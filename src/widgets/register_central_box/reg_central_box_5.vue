...
import input_login_or_email from '@/shared/ui/inputs/input_login_or_email_1.vue'
import recover_password from '@/widgets/register_text_under_header/recover_password.vue';
...
<template>
    ...
    <a href="/register6"><btn_next></btn_next></a>
    </div>     
    </div>
